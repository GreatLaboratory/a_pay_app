...
const autoPay = async (req, res, next) => {
    ...
    try {
        ...
        var thisMonthPayment = (previousPayment.createdAt.toLocaleString().substring(5, 7) != (nowMonth+1)) ? 0 : previousPayment.monthPayment + finalCost;
        var thisMonthBenefit = (previousPayment.createdAt.toLocaleString().substring(5, 7) != (nowMonth+1)) ? 0 : previousPayment.monthBenefit + benefitMoney;
...
// GET -> 전체 결제 내역 조회
const getAllPayHistory = async (req, res, next)=> {
...
// GET -> 각각의 카드 결제 내역 조회
const getEachPayHistory = async (req, res, next)=> {
...
export { autoPay, makeBestPayment, getAllPayHistory, getEachPayHistory };